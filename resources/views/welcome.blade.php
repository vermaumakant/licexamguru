...
<body>
  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        ...
        <li><a href="{{url('/teacher')}}">External</a></li>
      </ul>
    </nav>
  </header>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p><i class="fa fa-copyright"></i> Copyright 2020 by Umakant Verma  
          
           | Design: <a href="https://templatemo.com" rel="sponsored" target="_parent">Umakant Verema</a></p>
        </div>
      </div>
    </div>
  </footer>
